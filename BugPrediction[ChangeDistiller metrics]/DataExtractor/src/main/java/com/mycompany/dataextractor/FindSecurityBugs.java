...
public class FindSecurityBugs {
    ...
    private static Pattern defaultHttpClientBug = Pattern.compile("DefaultHttpClient()");
    private static Pattern weakSSLBug = Pattern.compile("SSLContext\\.getInstance\\(\"SSL\"\\)");
    private static Pattern customMessageDigestBug = Pattern.compile("extends MessageDigest\\(");
    private static Pattern nullCipherBug = Pattern.compile("new NullCipher()");
    ...
    public static void checkSecurityVulnerabilities(MatrixData matrixData, ObjectId objectId, Repository repo) throws IOException {
        ...
        matrixData.setDefaultHttpClientBug(checkvulnerability(objectId, defaultHttpClientBug, repo));
        matrixData.setWeakSSLBug(checkvulnerability(objectId, weakSSLBug, repo));
        matrixData.setCustomMessageDigestBug(checkvulnerability(objectId, customMessageDigestBug, repo));
        matrixData.setNullCipherBug(checkvulnerability(objectId, nullCipherBug, repo));
