...
public class AddSecurityBugs {
    ...
    // Directory path of Bug reports CSV files
    ...
    /**
     * Get all the CK metrics file names form given path
     * @return
    ...
    /**
     * Read bugs from Findbugs Report (CSV file)(get class name and bug name and bug frequency from files)
     */
    private static List<SecurityBugData> readReports(List<SecurityBugData> sbd, int file_num) {
        ...
        try {
            ...
            Map<String, String> rr = fileReader.read(readHeader);
            while ((row = fileReader.read(readHeader)) != null ) {
                ...
                for(SecurityBugData sb: sbd){
                    if(sb.getBugName().equals(bugName) && sb.getClassName().equals(className)) {
                        duplicate = true;
                ...
                if(!duplicate){
                    ...
                    // Set Frequency of each bug found
...
//                }
        ...
        // Get unique list of bug data
//        Set<SecurityBugData> unique = new HashSet<SecurityBugData>(sbd);
        return sbd;
    }
