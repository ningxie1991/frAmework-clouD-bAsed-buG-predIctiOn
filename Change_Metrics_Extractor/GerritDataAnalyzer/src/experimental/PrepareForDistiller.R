...
outputDir <- paste("../dataInputForDistiller/", projectName, "/", sep = "")
...
fwrite(first_last_patches_reduced, paste(outputDir, projectName, "Test_first_last_patches_for_distilling.csv", sep = ""))
